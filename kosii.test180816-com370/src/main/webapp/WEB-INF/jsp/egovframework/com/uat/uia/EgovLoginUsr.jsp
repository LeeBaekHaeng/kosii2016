...
<!--     <link href="https://getbootstrap.com/docs/4.1/dist/css/bootstrap.min.css" rel="stylesheet"> -->
    <link href="${pageContext.request.contextPath}/css/kosii/com/bootstrap.min.css" rel="stylesheet">
<%--     <link href="<c:url value="/css/kosii/com/bootstrap.min.css"></c:url>" rel="stylesheet"> --%>
<%--     <link href="<c:url value='/css/kosii/com/bootstrap.min.css'></c:url>" rel="stylesheet"> --%>
<%--     <link href="<c:url value='/css/kosii/com/bootstrap.min.css' />" rel="stylesheet"> --%>
...
<!--     <form class="form-signin"> -->
          <form class="form-signin" name="loginForm" action="<c:url value='/uat/uia/actionLogin.do'/>" method="post">
...
<input name="rdoSlctUsr" type="radio" value="radio" checked onClick="checkLogin('GNR');"  class="form-control" tabindex="1">일반
<input name="rdoSlctUsr" type="radio" value="radio" onClick="checkLogin('ENT');"  class="form-control" tabindex="2">기업
<input name="rdoSlctUsr" type="radio" value="radio" onClick="checkLogin('USR');"  class="form-control" tabindex="3">업무

      <label for="inputEmail" class="sr-only">Email address</label>
      <input type="text" name="id" id="id" class="form-control" placeholder="Email address" required autofocus>
      <label for="password" class="sr-only">Password</label>
      <input type="password" name="password" id="password" class="form-control" placeholder="Password" required onkeydown="if (event.keyCode == 13) { actionLogin(); }">
...
<!--       <button class="btn btn-lg btn-primary btn-block" type="submit">Sign in</button> -->
      <button class="btn btn-lg btn-primary btn-block" type="button" onclick="actionLogin()">Sign in</button>
